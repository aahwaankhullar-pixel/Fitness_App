        ...
        Container(
          ...
          Column(
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ExerciseScreen(exerciseType: "Pillow exercises", exerciseCategory: "Generalprops")));
                },
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ExerciseScreen(exerciseType: "Stuffed Toy", exerciseCategory: "Generalprops")));
                },
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ExerciseScreen(exerciseType: "Dumbell exercises", exerciseCategory: "Generalprops")));
                },
