      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [ Color(0xFFB2FF59), // Light Green (A200)
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildOptionCard(
                        ...
                        color2: Color.fromARGB(255, 181, 54, 101),
                        icon: Icons.insert_chart_outlined_sharp,
                      ),
                      _buildOptionCard(
                        context,
                        ...
                        color1: Color.fromARGB(255, 131, 233, 15),
                        color2: Color.fromARGB(255, 83, 201, 148),
                        icon: Icons.insert_chart_outlined_sharp,
                      ),
                      _buildOptionCard(
                        context,
                        ...
                        color1: Colors.amber,
                        color2: Color.fromARGB(255, 234, 148, 9),
                        icon: Icons.insert_chart_outlined_sharp,
                      ),
